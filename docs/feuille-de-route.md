...
<!-- <p class="fragment"><em>NB : <strong>en PHP</strong>, spécificité projets Wordpress : il ne faut pas faire de MCD sur la BDD de WP qui existe déjà. Vous devez créer un module/plugin afin d'<strong>ajouter au moins une table custom dans la BDD et sa liaison avec les autres tables déjà existantes</strong> Le MCD doit donc uniquement modéliser cette/ces table.s custom et la relation qui la/les lie aux tables WP.</em></p> -->
...
<li><strong>Chaque membre du groupe doit réaliser 2 wireframes minimum</strong> : une page en version mobile et en version desktop.</li>
